...
catalog = {
    ...
    "product_3": {
        "name": "Орехи: Кешью", 
        "description": "Один из самых благородных орехов\n\nИдеальный перекус для мозга и нервной системы, богатый магнием и полезными жирами.\n\nПоддерживает сердце, улучшает настроение и даже помогает сохранить красивую улыбку😁 \n\nКешью\nУпаковка 1000 г\nЦена 1000 ₽",
    ...
    "product_5": {
        "name": "Папайя сушеная", 
        "description": "Настоящая экзотика на вашем столе\n\nНапоминает спелую дыню или абрикос, но с более яркой, тропической сладостью и легкой кислинкой. Это непривычно и интересно для Сибири.\n\nОткрыайте для себя новое 😁\n\nПапайя сушеная\nУпаковка 500 г\nЦена 300 ₽",
        "photo_url": "https://files.catbox.moe/o1axyb.JPG"
    },
    "product_6": {
        "name": "Манго сушеное",
...
def handle_order(message):
    ...
    if chat_id in user_data and "city" in user_data[chat_id]:
        ...
        if message.text not in ["📖 Каталог товаров", "ℹ️ О нас"]:
            bot.send_message(
                chat_id,
